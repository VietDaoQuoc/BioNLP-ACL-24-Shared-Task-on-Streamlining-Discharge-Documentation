...
def generate_response_test(test_sample, test_retrieved_hadm_id_tv, train_valid_discharge) -> dict:
    ...
    samples_with_length_smaller_8192 = pd.read_csv("/nethome/vdquoc/project_dsai/output_files/list_smaller_8192_test_tv_updated.csv")
...
if __name__ == '__main__':
    ...
    df.to_csv('/nethome/vdquoc/project_dsai/output_files/huggingface_one_shot_with_rag_test_tv.csv')
    print('time of version one_shot_with_rag on TEST_PHASE_2 with train_valid combined')
